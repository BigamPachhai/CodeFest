...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Smart categorization and duplicate detection using artificial intelligence'
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: 'Government Integration',
      description: 'Direct connection with local authorities for faster resolution'
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-hero-pattern bg-nepali-blue text-white py-20">
